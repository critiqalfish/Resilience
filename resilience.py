...
class StartFrame(ttk.Frame):
    def __init__(self, window):
        ...
        self.credit = ttk.Button(self, text="Credits", command=lambda: window.switch_frame(CreditFrame))
        ...
        self.credit.pack(padx=30, pady=(10, 20), ipadx=10, side=tk.BOTTOM, anchor="e")
        self.start.pack(padx=30, ipadx=10, ipady=12, side=tk.BOTTOM, anchor="e")
...
class CreditFrame(ttk.Frame):
    def __init__(self, window):
        ttk.Frame.__init__(self, window, width=800, height=600)
        self.pack_propagate(False)
        self.cat = tk.PhotoImage(file="cat.png")

        self.title = ttk.Label(self, text="Credits", font=("Arial", 44))
        self.cat_img = tk.Label(self, image=self.cat)
        self.credits = ttk.Label(self, text="Developer: Colinus\nTheme: github.com/rdbende/Azure-ttk-theme", font=("Arial", 20))
        self.back = ttk.Button(self, text="Zurück", command=lambda: window.switch_frame(StartFrame))
        self.github = ttk.Button(self, text="Mein GitHub", command=lambda: webbrowser.open_new("https://github.com/critiqalfish/Resilience"))

        self.title.pack(pady=20)
        self.cat_img.pack()
        self.credits.pack(pady=(20, 0))
        self.back.pack(padx=30, pady=30, ipadx=10, ipady=10, side=tk.LEFT, anchor="s")
        self.github.pack(padx=30, pady=30, ipadx=10, ipady=10, side=tk.RIGHT, anchor="s")
